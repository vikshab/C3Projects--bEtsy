...
category_products = { 1 => [1, 2, 4, 5, 9, 12, 19, 21, 25, 27, 29, 34], 2 => [1, 3, 12, 19, 24, 29, 33, 34], 3 => [7, 13, 14, 15, 16, 17, 18], 4 => [6, 7, 8, 10, 11, 15, 18, 14, 19, 29, 34], 5 => [20, 21, 22, 23, 24, 25, 26, 27, 28, 30, 31, 32]}
